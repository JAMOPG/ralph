...
def test_backends_data_ldp_data_backend_default_instantiation(monkeypatch, fs):
    """Tests the `LDPDataBackend` default instantiation."""
...
def test_backends_data_ldp_data_backend_instantiation_with_settings(ldp_backend):
    """Tests the `LDPDataBackend` instantiation with settings."""
    backend = ldp_backend()
    assert isinstance(backend.client, ovh.Client)
...
def test_backends_data_ldp_data_backend_status_method_with_error_status(
    ...
    """Tests the `LDPDataBackend.status` method, given a failed request to OVH's archive
    endpoint, should return `DataBackendStatus.ERROR`.
    """

    def mock_get(_):
        """Mocks the ovh.Client get method that always raises an exception."""
        raise exception_class()

    def mock_get_archive_endpoint():
        """Mocks the `get_archive_endpoint` method that always raises an exception."""
    ...
    monkeypatch.setattr(backend, "get_archive_endpoint", mock_get_archive_endpoint)
    assert backend.status() == DataBackendStatus.ERROR
...
def test_backends_data_ldp_data_backend_status_method_with_ok_status(
    ...
    """Tests the `LDPDataBackend.status` method, given a successful request to OVH's
    archive endpoint, the `status` method should return `DataBackendStatus.OK`.
    """

    def mock_get(_):
        """Mocks the ovh.Client get method that always returns an empty list."""
        return []
...
def test_backends_data_ldp_data_backend_list_method_with_invalid_target(ldp_backend):
    """Tests the `LDPDataBackend.list` method given no default `stream_id` and no target
...
def test_backends_data_ldp_data_backend_list_method_failure(
    ...
    """Tests the `LDPDataBackend.list` method, given a failed OVH API request should
...
def test_backends_data_ldp_data_backend_list_method_without_history(
    ...
    """Tests the `LDPDataBackend.list` method without history."""
...
def test_backends_data_ldp_data_backend_list_method_with_details(
    ...
    """Tests the `LDPDataBackend.list` method with `details` set to `True`."""
    details_responses = [
        {
            "archiveId": archive,
...
def test_backends_data_ldp_data_backend_list_method_with_history(
    ...
    """Tests the `LDPDataBackend.list` method with history."""
...
def test_backends_data_ldp_data_backend_list_method_with_history_and_details(
    ...
    """Tests the `LDPDataBackend.list` method with a history and detailed output."""
    # pylint: disable=unused-argument
    details_responses = [
        {
            "archiveId": "archive_1",
...
def test_backends_data_ldp_data_backend_read_method_without_raw_ouput(
    ...
    """Tests the `LDPDataBackend.read method, given `raw_output` set to `False`, should
    ...
    backend = ldp_backend()
    monkeypatch.setattr(backend, "url", lambda *_: "/")
    monkeypatch.setattr(backend.client, "get", mock_get)
...
def test_backends_data_ldp_data_backend_read_method_without_ignore_errors(
    ...
    """Tests the `LDPDataBackend.read method, given `ignore_errors` set to `False`,
...
def test_backends_data_ldp_data_backend_read_method_with_invalid_query(ldp_backend):
    """Tests the `LDPDataBackend.read` method given an invalid `query` argument should
...
def test_backends_data_ldp_data_backend_read_method_with_failure(
    ...
    """Tests the `LDPDataBackend.read` method, given a request failure, should raise a
    `BackendException`.
    """
...
def test_backends_data_ldp_data_backend_read_method_with_query(
    ...
    """Tests the `LDPDataBackend.read` method, given a query argument."""
    # pylint: disable=invalid-name
...
def test_backends_data_ldp_data_backend_write_method(ldp_backend):
    """Tests the `LDPDataBackend.write` method."""
    backend = ldp_backend()
...
def test_backends_data_ldp_data_backend_get_archive_endpoint_method_with_valid_input(
    ...
    """Tests that the `LDPDataBackend.get_archive_endpoint` method, given valid input,
    should return the expected url.
    """
    assert ldp_backend().get_archive_endpoint(*args) == expected
...
def test_backends_data_ldp_data_backend_get_archive_endpoint_method_with_invalid_input(
    ...
    """Tests that the `LDPDataBackend.get_archive_endpoint` method, given invalid input
    ...
    with pytest.raises(
        ...
        ldp_backend(service_name=service_name, stream_id=None).get_archive_endpoint(
            stream_id
        )


def test_backends_data_ldp_data_backend_url_method(monkeypatch, ldp_backend):
    """Tests the `LDPDataBackend.url` method."""
    ...
    assert backend.url(archive_name) == archive_url
