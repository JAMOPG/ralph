...
@custom_given(
    custom_builds(BaseXapiStatement, actor=custom_builds(BaseXapiAgentWithAccountIFI))
)
...
@custom_given(
    st.one_of(
        ...
        custom_builds(
            BaseXapiStatement,
            actor=custom_builds(BaseXapiIdentifiedGroupWithMboxIFI),
        ),
        custom_builds(
            BaseXapiStatement,
            actor=custom_builds(BaseXapiIdentifiedGroupWithMboxSha1SumIFI),
        ),
        custom_builds(
            BaseXapiStatement,
            actor=custom_builds(BaseXapiIdentifiedGroupWithOpenIdIFI),
        ),
        custom_builds(
            BaseXapiStatement,
            actor=custom_builds(BaseXapiIdentifiedGroupWithAccountIFI),
        ),
    ),
    st.data(),
)
