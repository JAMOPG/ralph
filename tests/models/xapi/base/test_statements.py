...
from ralph.models.xapi.base.objects import BaseXapiSubStatementType
...
@pytest.mark.parametrize("value", [None, "", {}])
@custom_given(
    custom_builds(BaseXapiStatement, object=custom_builds(BaseXapiActivityType))
)
...
@custom_given(
    custom_builds(
        ...
        object=custom_builds(
            BaseXapiActivityType,
            definition=custom_builds(BaseXapiActivityTypeInteractionDefinition),
        ),
    )
)
...
@custom_given(
    custom_builds(
        BaseXapiStatement, actor=custom_builds(BaseXapiAgentTypeWithAccountIFI)
    )
)
...
@custom_given(
    custom_builds(BaseXapiStatement, actor=custom_builds(BaseXapiAnonymousGroupType))
)
...
@custom_given(
    st.one_of(
        custom_builds(
            BaseXapiStatement, actor=custom_builds(BaseXapiAnonymousGroupType)
        ),
        custom_builds(
            BaseXapiStatement,
            actor=custom_builds(BaseXapiIdentifiedGroupTypeWithMboxIFI),
        ),
        custom_builds(
            BaseXapiStatement,
            actor=custom_builds(BaseXapiIdentifiedGroupTypeWithMboxSha1SumIFI),
        ),
        custom_builds(
            BaseXapiStatement,
            actor=custom_builds(BaseXapiIdentifiedGroupTypeWithOpenIdIFI),
        ),
        custom_builds(
            BaseXapiStatement,
            actor=custom_builds(BaseXapiIdentifiedGroupTypeWithAccountIFI),
        ),
    ),
    st.data(),
)
...
@custom_given(
    custom_builds(BaseXapiStatement, object=custom_builds(BaseXapiSubStatementType))
)
...
@custom_given(
    st.one_of(
        custom_builds(
            BaseXapiStatement, object=custom_builds(BaseXapiSubStatementType)
        ),
        custom_builds(
            BaseXapiStatement, object=custom_builds(BaseXapiStatementRefType)
        ),
    ),
)
