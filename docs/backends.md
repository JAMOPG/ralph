...
LRS parameter required to connect is: 

- `connection_url`: the connection URL to connect to the server (_e.g._ [`http://ralph:secret@lrs:8100`])

Optional parameter can be configured if necessary: 
