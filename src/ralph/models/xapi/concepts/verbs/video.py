...
class PlayedVerb(BaseXapiVerb):
    ...
    display: Optional[Dict[LANG_EN_US_DISPLAY, VERB_PLAYED_DISPLAY]]
...
class PausedVerb(BaseXapiVerb):
    ...
    display: Optional[Dict[LANG_EN_US_DISPLAY, VERB_PAUSED_DISPLAY]]
...
class SeekedVerb(BaseXapiVerb):
    ...
    display: Optional[Dict[LANG_EN_US_DISPLAY, VERB_SEEKED_DISPLAY]]
